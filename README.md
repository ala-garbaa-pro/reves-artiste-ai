<div align="center">
  ...
  <h3 align="center">Rêve Artiste AI: Create with your words, live like an artist</h3>
...
- [pnpm](https://www.pnpm.io/) (pnPm Fast, disk space efficient package manager)

**Cloning the Repository**

```bash
git clone https://github.com/ala-garbaa-pro/reves-artiste-ai.git
cd reves-artiste-ai
```
...
export async function getAllImages({ limit = 9, page = 1, searchQuery = '' }: {
  ...
  try {
    ...
    let expression = 'folder=reves_artiste_ai';
